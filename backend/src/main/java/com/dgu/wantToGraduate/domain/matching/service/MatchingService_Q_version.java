...
//        Long userId = getUserId();
        ...
        User userEntity = userRepository.findById(getUserId()).orElseThrow(()
        ...
        for(SelectDto selectDto : selectInfo.getPreferBrandList()){
            ...
            matchingResult = insertIntoBrandQueue(selectDto, getUserId());// 매장 큐에 유저 삽입
...
//    }
    ...
    private Long getUserId(){ //TODO: CPU부하 테스트 완료 후, 적용
